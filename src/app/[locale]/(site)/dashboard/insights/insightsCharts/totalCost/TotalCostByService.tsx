...
export const TotalCostByService = () => {
    return (
        <Container>
            <Chart type="pie" series={series} options={options} height={270} />
            <style>{`
          .apexcharts-tooltip {
            padding: 10px;
          }
...
const options: Props['options'] = {
    ...
    labels: ['Oil Change', 'Tire Rotation', 'Brake Service', 'Wheel Alignment', 'Others'],
